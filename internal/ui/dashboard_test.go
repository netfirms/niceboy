...
func TestNewModel(t *testing.T) {
	m := NewModel("binance", "BTCUSDT", true, nil, "sma_crossover", map[string]interface{}{"short": 5}, 0.01, "dev", "test", "binance_test", nil)
...
func TestModelUpdates(t *testing.T) {
	m := NewModel("bitkub", "THB_BTC", false, nil, "sma_crossover", nil, 0.01, "dev", "test", "bitkub_test", nil)
...
func TestViewRendering(t *testing.T) {
	m := NewModel("binance", "BTCUSDT", false, nil, "sma_crossover", map[string]interface{}{"fast_period": 10.0, "slow_period": 21.0}, 0.001, "dev", "testcommit123", "binance_prod", nil)
	m.Width = 100
	m.Height = 40
	m.Ready = true
	m.Viewport = viewport.New(100, 20)
